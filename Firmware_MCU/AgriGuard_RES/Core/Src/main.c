...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(SPI_LORA_CS_GPIO_Port, SPI_LORA_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, FPGA_RESET_Pin|GPIO_PIN_14, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : SPI_LORA_CS_Pin */
  GPIO_InitStruct.Pin = SPI_LORA_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(SPI_LORA_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : FPGA_RESET_Pin PG14 */
  GPIO_InitStruct.Pin = FPGA_RESET_Pin|GPIO_PIN_14;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);
